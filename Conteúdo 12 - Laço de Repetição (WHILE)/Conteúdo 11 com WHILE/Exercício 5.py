...
print(f"Primeiro canditado teve um total de {votocanditado1}  votos.")
print(f"Segundo canditado teve um total de {votocantidato2}  votos.")
print(f"Terceiro canditado teve um total de {votocantidato3}  votos.")
print(f"Quarto canditado teve um total de {votocantidato4}  votos.")
print(f"Teve um total de {votonulo}  votos nulos.")
print(f"Teve um total de {votobranco}  votos em branco.")